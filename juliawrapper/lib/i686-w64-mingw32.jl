...
const MTKt_int8 = Cchar

const MTKt_uint8 = Cuchar

const MTKt_int16 = Cshort

const MTKt_uint16 = Cushort

const MTKt_int32 = Cint

const MTKt_uint32 = Cuint

const MTKt_int64 = Clong

const MTKt_uint64 = Culong
...
function MtkHdfToMtkDataTypeConvert(hdf_datatype, datatype)
    ccall((:MtkHdfToMtkDataTypeConvert, mtklib), MTKt_status, (int32, Ptr{MTKt_DataType}), hdf_datatype, datatype)
end

function MtkNcToMtkDataTypeConvert(nc_datatype, datatype)
    ccall((:MtkNcToMtkDataTypeConvert, mtklib), MTKt_status, (nc_type, Ptr{MTKt_DataType}), nc_datatype, datatype)
end
